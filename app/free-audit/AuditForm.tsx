...
const whatYouGet = [
  { icon: '🔍', title: 'Speed & Performance Check', desc: "See your real Core Web Vitals score and what's slowing you down." },
  { icon: '📈', title: 'SEO Gap Analysis', desc: "Find out exactly why Google can't find you — and what to fix first." },
  { icon: '🎯', title: 'Conversion Review', desc: "What's stopping visitors from contacting you — and how to fix it." },
]

const auditFaq = [
  { q: 'Is this really free?', a: 'Yes, always. No credit card, no trial, no catch.' },
  { q: 'Will you try to sell me something?', a: "We'll share what we found. If you want help fixing it, that's a separate conversation — your choice entirely." },
  { q: "What if I don't have a website yet?", a: "Even better — we'll audit your top competitors and show you exactly what you need to beat them." },
]
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
              {!submitted ? (
                <div className="bg-dark-card rounded-2xl p-8 glow-border">
                  <h2 className="font-heading text-xl font-bold text-text-primary mb-6">Book Your Free Audit</h2>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="space-y-6">
            {[
              ...
              { n: '2', t: 'We review your site', d: 'Our team does a thorough audit within 24 hours.' },
