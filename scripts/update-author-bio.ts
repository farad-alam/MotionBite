...
const SHORT_BIO =
  "Web designer & developer with 5+ years helping small businesses get found on Google. CEO of MotionBite. I build websites that actually bring in customers."
...
const FULL_BIO = [
  ...
  para(
    "I write on this blog to share everything I've learned about web design, SEO, and digital strategy in plain English — no jargon, no gatekeeping. If you're a small business owner who wants to understand why your website isn't showing up on Google, or what a professional website actually costs, these guides are written for you."
  ),
]
